...
<script type="text/javascript" src="/cls/js/reBoard1.js"></script>
</head>
<body>
	<form method="POST" action="/cls/reBoard1/reBoardDelProc.cls" id="frm1" name="frm1">
			...
			<div class="w3-container w3-padding">
				...
				<div class="w3-col">
					<div class="w3-col inblock avtbox100 pdr10">
						<img src="/cls/avatar/${AVTIMG}" class="avtimg100 w3-border">
					</div>
	...
	<div class="w3-content w3-center mw650">
		...
		<div class="w3-col w3-margin-top">
			<form method="POST" action="/cls/reBoard1/reBoardList.cls" name="pfrm" id="pfrm" class="w3-bar w3-border w3-round">
